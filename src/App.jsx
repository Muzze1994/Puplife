...
export class App extends Component {
  ...
  render() {
    ...
    return (
      ...
      <ErrorBoundary>
        <NightModeContext.Provider value={{ nightMode: this.state.nightMode, changeNightMode: this.handleChangeNightMode.bind(this)}}>
            ...
            <ThemableDiv>
              <Router>
                ...
                <Footer>
                  ...
                  <Link to="/" className="Footer-icon"><i className="fas fa-info-circle fa-2x"></i></Link>

                  <Link to="/forum" className="Footer-icon" ><i className="far fa-comments fa-2x"></i></Link>

                  <Link to="/webshop" className="Footer-icon"><i className="fas fa-store fa-2x"></i></Link>

                  <Link to="/myprofile" className="Footer-icon"><i className="fas fa-dog fa-2x"></i> </Link>
                </Footer>
