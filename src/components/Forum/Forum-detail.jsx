...
import { getOneBlogPost } from '../../api/Get-one-blog-post.js';
...
class ForumDetail extends Component {
    ...
    componentDidMount() {
        getOneBlogPost(this.props.match.params.id)
            .then(res => {
                    ...
                    <div className="card-body p-2 p-sm-3">
                        <div className="media forum-item">
                            ...
                            <div className="media-body">
                                <h6>
                                        <a href="#" data-toggle="collapse" data-target=".forum-content" className="text-body">Reply</a>
                                </h6>
                                <p className="text-secondary">
                                    Hey this is a reply
                                </p>
                                <p className="text-muted">Anon posted <span className="text-secondary font-weight-bold">on a random date</span></p>
